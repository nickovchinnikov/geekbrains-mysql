...
DROP PROCEDURE IF EXISTS sc_data_fulfill;
DELIMITER //
CREATE PROCEDURE sc_data_fulfill()
BEGIN

  SET @i = 1;
  REPEAT
    INSERT INTO users VALUES (@i, CONCAT('user', FORMAT(@i, 0)) );
    SET @i = @i + 1;
  UNTIL @i > 10
  END REPEAT;
  ...
  SET @j = 10;
  REPEAT
    INSERT INTO likes VALUES (@i, @i, @j);
    SET @i = @i + 1;
    SET @j = @j - 1;
  UNTIL @i > 10
  END REPEAT;
